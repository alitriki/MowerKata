...
const Mower_1 = require("../src/Mower");
const chai_1 = require("chai");
var chai = require('chai');
describe('Mower tests', () => {
    var mower = new Mower_1.Mower(0, 0, 'N', 5);
    ...
    it("orientation should be 'E' after turning right", () => {
        mower.orientation = 'N';
        mower.turnRight();
        chai_1.assert.equal(mower.orientation, 'E');
    });
    it("orientation should be 'S' after turning right", () => {
        mower.turnRight();
        chai_1.assert.equal(mower.orientation, 'S');
    });
    it("orientation should be 'W' after turning right", () => {
        mower.turnRight();
        chai_1.assert.equal(mower.orientation, 'W');
    });
    it("orientation should be 'N' after turning right", () => {
        mower.turnRight();
        chai_1.assert.equal(mower.orientation, 'N');
    });
    ...
    it("Xposition should increment by 1 after going forward", () => {
        ...
        mower.goForward();
        chai_1.assert.equal(oldXposition + 1, mower.Xposition);
    });
    it("Yposition should increment by 1 after going forward", () => {
        mower.orientation = 'N';
        let oldYposition = mower.Yposition;
        mower.goForward();
        chai_1.assert.equal(oldYposition + 1, mower.Yposition);
    });
    ...
    it("Xposition should not change after going forward becose thi lawn limit is reached", () => {
        ...
        let oldXposition = mower.Xposition;
        mower.goForward();
        chai_1.assert.equal(oldXposition, mower.Xposition);
    });
    it("Yposition should not change after going forward becose thi lawn limit is reached", () => {
        ...
        let oldYposition = mower.Yposition;
        mower.goForward();
        chai_1.assert.equal(oldYposition, mower.Yposition);
    });
    it("Xposition should not change after going forward becose thi lawn limit is reached", () => {
        mower.orientation = 'W';
        mower.Xposition = 0;
